...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex relative overflow-hidden">
      ...
      <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-indigo-600/20 rounded-full mix-blend-screen filter blur-[128px] animate-pulse pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-purple-600/20 rounded-full mix-blend-screen filter blur-[128px] animate-pulse delay-1000 pointer-events-none" />
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative z-10 border-r border-white/5 bg-black/20 backdrop-blur-3xl">
        ...
        >
          ...
          <p className="text-gray-400 text-lg mb-8 leading-relaxed">
            Join thousands of teams already using TaskMatrix to organize their work, automate workflows, and boost productivity.
          </p>
              ...
              <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className={`block w-full px-4 py-3 bg-white/5 border ${
                        errors.name ? 'border-red-500/50 focus:border-red-500' : 'border-white/10 focus:border-purple-500/50'
                    ...
                    />
                    <div className={`absolute inset-0 rounded-xl pointer-events-none transition-opacity duration-300 ${errors.name ? 'opacity-100 ring-1 ring-red-500/50' : 'opacity-0 group-focus-within:opacity-100 ring-1 ring-purple-500/50'}`} />
                    {errors.name && (
                ...
                >
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className={`block w-full px-4 py-3 bg-white/5 border ${
                        errors.confirmPassword ? 'border-red-500/50 focus:border-red-500' : 'border-white/10 focus:border-purple-500/50'
                      } rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-0 focus:bg-white/10 transition-all duration-300 pr-12`}
                      placeholder="••••••••"
                    />
                    <div className={`absolute inset-0 rounded-xl pointer-events-none transition-opacity duration-300 ${errors.confirmPassword ? 'opacity-100 ring-1 ring-red-500/50' : 'opacity-0 group-focus-within:opacity-100 ring-1 ring-purple-500/50'}`} />
                    <button
                      type="button"
                      className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-gray-200 transition-colors focus:outline-none"
                ...
                >
                  <button
                    ...
                    className="group w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-xl text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#050505] focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_25px_rgba(99,102,241,0.5)]"
                  >
                    {isSubmitting ? (
                      <>
